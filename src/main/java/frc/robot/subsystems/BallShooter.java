/**
 * if (currentrmp < setpointrpm) motor value = 1 else motovalue = 0;
 */
...
private DigitalInput limitSwitchDown;
     ...
     */
    public BallShooter() {
        SmartDashboard.putNumber("sdShoot RPMS", -3360);
        SmartDashboard.putNumber("sdHood Position", 4500);
...
addChild("limitSwitchDown",limitSwitchDown);
    ...
    /**
     * idleSubsystem() will stow the hood and idle the motor based on constants
